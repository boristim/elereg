<?php
// SMSC.RU API (smsc.ru) версия 1.4 (26.01.2017)
...
class SMSC_SMPP
{
    ...
    {
        $pdu = pack("a" . strlen($this->login) . "xa" . strlen($this->password) . "xa" . strlen($system_type) . "xCCCx", $this->login, $this->password, $system_type, 0x34, 5, 1); // body
